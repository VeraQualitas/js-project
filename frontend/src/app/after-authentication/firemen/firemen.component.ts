...
@Component({
  selector: 'app-firemen',
  templateUrl: './firemen.component.html',
  styleUrls: ['../after-authentication.scss', './firemen.component.scss']
})
export class FiremenComponent implements OnInit {
